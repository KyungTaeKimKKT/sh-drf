...
### const
TABLE_HEADER_SCM_제품 = ['id','stock_fk','stock_fk__생산관리_제품완료_fk', 'stock_fk__창고_fk', 'stock_fk__창고_fk__창고명',
	'상태','수량', '출고처_fk','출고처',
	'고객사','구분','Job_Name','Proj_No', '계획수량','소재','치수', '공정명',
	'처리자','생성시간',
	]
...
class DB_Field_SCM_제품_View(APIView):
	""" DB FILED VIEW {NAME:TYPE}"""
	MODEL = models.SCM_제품
	_Serializer = serializers.SCM_제품_Serializer
	...
	def _init_res_dict(self):
		...
		self.res_dict = {
			...
			'table_config' : {
				...
				#############
				'table_header' : TABLE_HEADER_SCM_제품,
				'no_Edit_cols' : ['id'],
				...
				'hidden_columns' :[],
				'cols_width' : COLS_WIDTH_SCM_제품 ,
				'no_vContextMenuCols' : TABLE_HEADER_SCM_제품 ,### vContext menu를 생성하지 않는 col.
				'no_hContextMenuRows' :[],
				'v_Menus' : {
				},
				'h_Menus' : {
